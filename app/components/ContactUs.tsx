      ...
      <div className="flex flex-wrap -mx-4 lg:justify-between">
         <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
               ...
               <h2
                  className="text-gray-950 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                  >
            ...
            <div
               ...
               <form>
                  ...
                  <div>
                     <button
                        type="submit"
                        className="w-full p-3 text-white bg-gray-900 transition border rounded border-primary bg-primary hover:bg-opacity-90"
                        >
                     Send Message
                     </button>
                  </div>
